...
Научилась писать свои методы вызывать их через точку вход , также использовали библиотеки и методы такие как math date time, писать функции с нексколькими аргументами масивами и кортежами
