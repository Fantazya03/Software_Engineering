...
Класс Tomato: представляет томат с различными стадиями созревания. Обладает методами для роста томата (метод grow) и проверки его зрелости (метод is_ripe).
Класс TomatoBush: управляет группой томатов, предоставляя методы для роста всех томатов сразу (grow_all) и проверки их спелости (all_are_ripe).
Класс Gardener: садовник, ухаживающий за растениями. Использует метод work для ухода и метод harvest для сбора урожая, когда все томаты созрели.
Также предусмотрена вспомогательная функция knowledge_base, выводящая информацию о правилах ухода за растениями.
